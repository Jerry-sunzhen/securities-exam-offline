...
export const sprintPlan = {
  ...
  blocks: [
    ...
    },
    {
      ...
      focus: "law",
      title: "间隙 · 法规错题收尾",
      detail: "五章都刷过了，这段把错题本里剩下的法规错题清空：只重做，不再精读解析，做错的当场看一句结论就走。",
    ...
    },
    {
      ...
      focus: "law",
      title: "间隙 · 法规多年考点",
      detail: "36 个多年考点里 29 个在第一、二章，重复率最高，优先过这两章；遇到拿不准的只记结论。",
    ...
    },
    {
      ...
      focus: "law",
      title: "间隙 · 法规多选专练",
      detail: "下午 40 道多选、每题 1 分且少选错选都不得分。现在多选题的选项本身就是条款，选全对的才给分，正好用这段练手感。",
      tasks: [{ kind: "practice", subjectId: "law", count: 20, types: ["multiple"], label: "法规多选 20 题" }]
    },
    {
      id: "sat-gap-review",
      date: "2026-09-19",
  ...
  notes: [
    {
      ...
      items: [
        ...
        "10:30—13:00 按「吃饭 → 法规错题收尾 → 多年考点 → 多选专练 → 结论速览 → 进考场」走，两个半小时用满，但不加新内容。",
        "第一到第五章都已经刷过一轮，间隙不再回去补章节题，重点放在错题、多年考点和多选手感上。",
    ...
    },
    {
      title: "时间不够时的取舍顺序",
      items: [
        "先砍 12:10 的多选专练，再砍 11:40 的多年考点。",
        "不能砍：11:00 的法规错题、10:30 的吃饭、12:45 的进考场。",
        "进考场时间紧张就按「错题 → 多年考点 → 进考场」的顺序保，多选专练和速览都可以放弃。",
