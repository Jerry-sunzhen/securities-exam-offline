...
export const sprintPlan = {
  ...
  blocks: [
    ...
    },
    {
      ...
      focus: "law",
      title: "间隙 · 法规错题收尾",
      detail: "档案里法规还剩 47 道错题（第一章 16、第三章 13、第二章 10）。只重做，不再精读解析，做错的当场看一句结论就走。",
      tasks: [{ kind: "wrong", subjectId: "law", label: "收尾法规错题 47 道" }]
    },
    {
      id: "sat-gap-multiple",
      date: "2026-09-19",
      ...
      focus: "law",
      title: "间隙 · 法规多选专练",
      detail: "法规多选 401 道只做过 114 道，实测正确率 83%。下午多选 40 题、每题 1 分，是单块分值最大的题。这段只练多选，选全对才算对。",
      tasks: [{ kind: "practice", subjectId: "law", count: 24, types: ["multiple"], label: "法规多选 24 题" }]
    },
    {
      id: "sat-gap-case",
      date: "2026-09-19",
      ...
      focus: "law",
      title: "间隙 · 法规综合题上手",
      detail: "23 道综合题一道都没做过，下午有 10 道材料题。做 8 道熟悉「一段材料带几小问」的读法即可，不追求做完。",
      tasks: [{ kind: "practice", subjectId: "law", count: 8, types: ["case"], label: "法规综合题 8 题" }]
    },
    {
      id: "sat-gap-review",
      date: "2026-09-19",
      ...
      focus: "law",
      title: "结论与数字速览",
      detail: "只扫期限、比例、人数、金额、处罚幅度；12:45 之后不再输入新内容，也不再做题。",
  ...
  notes: [
    {
      ...
      items: [
        ...
        "10:30—13:00 按「吃饭 → 法规错题收尾 → 多选专练 → 综合题上手 → 结论速览 → 进考场」走，两个半小时用满，但不加新内容。",
        "第一到第五章都已经刷过一轮，间隙不再回去补章节题。多年考点那 115 道已经全部做过，不再排；法规真正的缺口在多选：401 道只做过 114 道，而下午多选有 40 分。",
    ...
    },
    {
      title: "时间不够时的取舍顺序",
      items: [
        "先砍 12:15 的综合题上手，再砍 12:35 的结论速览。",
        "不能砍：11:00 的法规错题、10:30 的吃饭、12:45 的进考场。",
        "进考场时间紧张就按「错题 → 多选专练 → 进考场」的顺序保，综合题和速览都可以放弃。",
